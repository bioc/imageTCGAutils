...
from whole-slide images (WSIs). Each tile corresponds to a patch of the tissue,
and its embedding is a high-dimensional vector capturing visual and
morphological features extracted from Prov-GigaPath.
